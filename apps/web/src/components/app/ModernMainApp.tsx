      ...
      <div className="flex-1 flex overflow-hidden">
            ...
            {connectedVoiceChannelId && (
              <ModernVoicePanel
                ...
                memberCount={voiceUsers.length}
                voiceUsers={voicePanelUsers}
                myUserId={user?.id}
                ...
                remoteScreenSharerName={activeScreenSharer?.username}
                ...
                onToggleVideo={handleToggleVideoPlayback}
                onToggleScreenShare={handleToggleScreenShare}
                onToggleShareSystemAudio={handleToggleShareSystemAudio}
                onSelectScreenQuality={setScreenQuality}
                onLeave={handleLeaveVoiceChannel}
                onOpenSettings={() => setShowSettingsModal(true)}
                onTogglePushToTalk={handleTogglePushToTalk}
                onOpenAdvancedScreenShare={handleOpenAdvancedScreenShare}
                onRequestTheaterMode={activeScreenSharer ? handleRequestTheaterMode : undefined}
                onOpenMusicPlayer={() => setShowMusicPlayer(true)}
                onUserContextMenu={(voiceUserId, displayName, event) => {
                  setContextMenu({
                    userId: voiceUserId,
